...
| `.go`, `go.mod` | `languages/go.md` *(not currently installed)* |
| `.rs`, `Cargo.toml` | `languages/rust.md` *(not currently installed)* |
| `.java`, `spring`, `@Controller` | `languages/java.md` *(not currently installed)* |
...
| K8s manifests, Helm charts | `infrastructure/kubernetes.md` *(not currently installed)* |
| `.tf`, Terraform | `infrastructure/terraform.md` *(not currently installed)* |
| GitHub Actions, `.gitlab-ci.yml` | `infrastructure/ci-cd.md` *(not currently installed)* |
| AWS/GCP/Azure configs, IAM | `infrastructure/cloud.md` *(not currently installed)* |
...
- `go.md` - Go-specific security patterns *(not currently installed)*
- `rust.md` - Rust unsafe blocks, FFI security *(not currently installed)*
- `java.md` - Spring, Java EE patterns *(not currently installed)*

### Infrastructure (`infrastructure/`)
- `docker.md` - Container security
- `kubernetes.md` - K8s RBAC, secrets, policies *(not currently installed)*
- `terraform.md` - IaC security *(not currently installed)*
- `ci-cd.md` - Pipeline security *(not currently installed)*
- `cloud.md` - AWS/GCP/Azure security *(not currently installed)*
